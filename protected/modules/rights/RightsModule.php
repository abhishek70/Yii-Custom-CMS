...
class RightsModule extends CWebModule
{
	...
	*/
	public function init()
	{
		...
		Yii::app()->user->setStateKeyPrefix('_rights');
	}
	...
	public function beforeControllerAction($controller, $action)
	{
			if(parent::beforeControllerAction($controller, $action))
            {
               /* echo '<pre>';
				...
				if(isset($_SESSION['_admin__id']) && $_SESSION['_admin__id']!='')
				{
					Yii::app()->getModule('rights')->user->setReturnUrl('rights/assignment');  
                    return true;
				}
				else
				{
					Yii::app()->getModule('rights')->user->loginRequired();  
				}
